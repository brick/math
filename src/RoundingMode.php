 ...
 * be referred to as the discarded fraction regardless the digits' contribution to the value of the number. In other
...
final class RoundingMode
{
     ...
     *
     * If this rounding mode is specified on an operation that yields a result that cannot be represented at the
     * requested scale, a RoundingNecessaryException is thrown.
     */
     ...
     * even neighbor.
     *
     * Behaves as for HALF_UP if the digit to the left of the discarded fraction is odd; behaves as for HALF_DOWN if
     * it's even.
     *
