 ...
 *
 * Unless otherwise specified, all parameters must be validated as non-empty strings of digits, without leading zero,
 * and with an optional leading minus sign if the number is not zero.
 *
 * Any other parameter format will lead to undefined behaviour. All methods must return strings respecting this format,
...
abstract class Calculator
{
     ...
     */
    final public static function set(?self $calculator): void
    {
     ...
     *
     * This method can be overridden by the concrete implementation if the underlying library has built-in support for
     * GCD calculations.
     *
     * @param string $a The first number.
     * @param string $b The second number.
     ...
     * @codeCoverageIgnore
     */
    private static function detect(): self
    {
